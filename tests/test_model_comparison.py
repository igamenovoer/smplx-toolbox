...
class SMPLModelComparator:
    ...
    def __init__(self) -> None:
        ...
        self.m_console: Optional[Console] = None
        self.m_base_path: Optional[Path] = None
        self.m_models: Optional[List[ModelInfo]] = None
        self.m_model_data: Optional[Dict[str, Dict[str, Any]]] = None
    ...
    def extract_model_info(self, model_name: str, filepath: Path, 
        ...
        # Check for hands
        has_hands = any('hand' in k.lower() for k in model_data.keys())
